...
class Group(models.Model):
    ...
    email=models.EmailField(verbose_name="email of group", max_length=150)
...
class Student(models.Model):
    ...
    #the previous line is equivalent to the following in SQL syntax
...
class Module(models.Model):
    ...
    due=models.FloatField(max_digits=4,decimal_places=2,default=21)
    model_type=models.CharField(max_length=50)
    level= models.CharField(max_length=100,choices=StudyLevel.choices(),default=StudyLevel.FirstClass)
    #specification of the many to many relationship between Module and Group
    study=models.ManyToManyField(Group,null=True,blank=True)
...
class TeacherModules(models.Model):
    ...
    year=models.IntegerField(default=timezone.now)   
